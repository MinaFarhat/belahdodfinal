...
import 'Core/third_party_injection.dart' as _i207;
import 'Core/utils/shared_preference_utils.dart' as _i7;
import 'Features/Auth/Create%20Account/cubit/createaccount_cubit.dart' as _i155;
...
import 'Features/Auth/Create%20Account/Data/Web%20Service/createaccountwebservice.dart'
    as _i22;
import 'Features/Auth/Login/cubit/login_cubit.dart' as _i170;
import 'Features/Auth/Login/data/Repostry/basereposotrylogin.dart' as _i96;
import 'Features/Auth/Login/data/Repostry/loginreposotry.dart' as _i97;
...
import 'Features/User/Details/data/Web%20Service/stationery_webservice.dart'
    as _i65;
import 'Features/User/Details/Manager/Base%20Cubit/base_cubit.dart' as _i148;
import 'Features/User/Details/Manager/Book%20Cubit/book_cubit.dart' as _i206;
import 'Features/User/Details/Manager/DisLike%20Cubit/dis_like_cubit.dart'
    as _i134;
import 'Features/User/Details/Manager/Game%20Cubit/game_cubit.dart' as _i117;
import 'Features/User/Details/Manager/Like%20Cubit/like_cubit.dart' as _i169;
...
import 'Features/User/favorite/Manager/Get%20Favorites%20Cubit/getfavorites_cubit.dart'
    as _i202;
import 'Features/User/homepage/HomeScreen/cubit/section_cubit.dart' as _i133;
...
import 'Features/User/news/data/Repostry/News/baserepositorymewdetails.dart'
    as _i98;
import 'Features/User/news/data/Repostry/News/baserepositorynews.dart' as _i165;
import 'Features/User/news/data/Repostry/News/newdetailsrepository.dart'
    as _i99;
import 'Features/User/news/data/Repostry/News/newsrepository.dart' as _i166;
...
import 'Features/User/news/Manager/New%20Details%20Cubit/new_details_cubit.dart'
    as _i102;
import 'Features/User/news/Manager/News%20Cubit/news_cubit.dart' as _i197;
import 'Features/User/note/cubit/get_notifications_cubit.dart' as _i199;
import 'Features/User/note/data/Repostry/baserepositorygetnotifications.dart'
    as _i153;
import 'Features/User/note/data/Repostry/getnotificationsentity.dart' as _i154;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i79.GetProductsMainSectionCubit>(() =>
        _i79.GetProductsMainSectionCubit(
            gh<_i42.BaseRepositoryGetProductsMainSection>()));
    gh.singleton<_i80.OnArrivalWebService>(
        () => _i80.OnArrivalWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i81.BaseRepositoryDetailsofOffer>(
        () => _i82.DetailsofOfferRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              detailsofOfferWebService: gh<_i40.DetailsofOfferWebService>(),
            ));
    gh.singleton<_i83.GetCitiesWebService>(
        () => _i83.GetCitiesWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i84.BaseRepositoryUpdateUserInfo>(
        () => _i85.UpdateUserInfoRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              updateUserInfoWebService: gh<_i71.UpdateUserInfoWebService>(),
            ));
    gh.singleton<_i86.GetUserInfoWebService>(
        () => _i86.GetUserInfoWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i87.SearchByQrWebService>(
        () => _i87.SearchByQrWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i88.BaseRepositoryOrderDetails>(
        () => _i89.OrderDetailsRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              orderDetailsWebService: gh<_i23.OrderDetailsWebService>(),
            ));
    gh.singleton<_i90.BaseRepositoryDeleteAccount>(
        () => _i91.DeleteAccountRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              deleteAccountWebService: gh<_i45.DeleteAccountWebService>(),
            ));
    gh.singleton<_i92.BaseRepositoryGetAllOffers>(
        () => _i93.GetAllOffersRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              getAllOffersWebService: gh<_i78.GetAllOffersWebService>(),
            ));
    gh.singleton<_i94.BaseRepositorySendOffer>(
        () => _i95.SendOfferRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              sendOfferWebService: gh<_i59.SendOfferWebService>(),
            ));
    gh.singleton<_i96.BaseReposotryLogin>(() => _i97.LoginReposotryImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          loginWebService: gh<_i66.LoginWebService>(),
        ));
    gh.singleton<_i98.BaseRepositoryNewDetails>(
        () => _i99.NewDetailsRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              newDetailsWebService: gh<_i34.NewDetailsWebService>(),
            ));
    gh.singleton<_i100.BaseRepositoryAddToFavorites>(
        () => _i101.AddToFavoritesRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              addToFavoriteWebService: gh<_i74.AddToFavoritesWebService>(),
            ));
    gh.factory<_i102.NewDetailsCubit>(
        () => _i102.NewDetailsCubit(gh<_i98.BaseRepositoryNewDetails>()));
    gh.singleton<_i103.BaseRepositoryGetProductsOfSubSection>(
        () => _i104.GetProductsofSubSectionRepository(
              networkInfo: gh<_i8.NetworkInfo>(),
              getProductsofSubSectionWebService:
                  gh<_i41.GetProductsofSubSectionWebService>(),
            ));
    gh.singleton<_i105.BaseRepositorySearchByQr>(
        () => _i106.SearchByQrRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              searchByQrWebService: gh<_i87.SearchByQrWebService>(),
            ));
    gh.singleton<_i107.BaseRepositoryGame>(() => _i108.GameRepository(
          networkInfo: gh<_i8.NetworkInfo>(),
          gameWebService: gh<_i39.GameWebService>(),
        ));
    gh.singleton<_i109.BaseRepositoryCartItems>(
        () => _i110.GetCartItemsRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              cartItemsWebService: gh<_i67.CartItemsWebService>(),
            ));
    gh.factory<_i111.GetsubsectionsCubit>(() =>
        _i111.GetsubsectionsCubit(gh<_i36.BaseRepositoryGetSubSections>()));
    gh.singleton<_i112.BaseRepositoryGetCities>(
        () => _i113.GetCitiesRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              getCitiesWebService: gh<_i83.GetCitiesWebService>(),
            ));
    gh.singleton<_i114.BaseRepositoryStationery>(
        () => _i115.StationeryRepository(
              networkInfo: gh<_i8.NetworkInfo>(),
              stationeryWebService: gh<_i65.StationeryWebService>(),
            ));
    gh.factory<_i116.UpdateUserInfoCubit>(() =>
        _i116.UpdateUserInfoCubit(gh<_i84.BaseRepositoryUpdateUserInfo>()));
    gh.factory<_i117.GameCubit>(
        () => _i117.GameCubit(gh<_i107.BaseRepositoryGame>()));
    gh.singleton<_i118.BaseRepositorySection>(() => _i119.SectionRepositoryImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          sectionWebService: gh<_i16.SectionWebService>(),
        ));
    gh.singleton<_i120.BaseRepositoryDisLike>(() => _i121.DisLikeRepositoryImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          disLikeWebService: gh<_i15.DisLikeWebService>(),
        ));
    gh.factory<_i122.GetVouchersCubit>(
        () => _i122.GetVouchersCubit(gh<_i53.BaseRepositoryGetVouchers>()));
    gh.factory<_i123.PopularProductsCubit>(() =>
        _i123.PopularProductsCubit(gh<_i57.BaseRepositoryPopularProducts>()));
    gh.singleton<_i124.BaseRepositoryStationeryVisitor>(() =>
        _i125.StationeryRepositoryVisitorImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          stationeryWebServiceVisitor: gh<_i12.StationeryWebServiceVisitor>(),
        ));
    gh.singleton<_i126.BaseRepositoryTransfer>(
        () => _i127.TransferRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              transferWebService: gh<_i47.TransferWebService>(),
            ));
    gh.factory<_i128.QuantitiyupdateCubit>(() =>
        _i128.QuantitiyupdateCubit(gh<_i62.BaseRepositoryQuantityUpdate>()));
    gh.singleton<_i129.BaseRepositoryUpdateProfilePhoto>(() =>
        _i130.UpdateProfilePhotoRepositoryImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          updateProfilePhotoWebService: gh<_i17.UpdateProfilePhotoWebService>(),
        ));
    gh.singleton<_i131.BaseRepositoryQuraan>(() => _i132.QuraanRepository(
          networkInfo: gh<_i8.NetworkInfo>(),
          quraanWebService: gh<_i11.QuraanWebService>(),
        ));
    gh.factory<_i133.SectionCubit>(
        () => _i133.SectionCubit(gh<_i118.BaseRepositorySection>()));
    gh.factory<_i134.DisLikeCubit>(
        () => _i134.DisLikeCubit(gh<_i120.BaseRepositoryDisLike>()));
    gh.factory<_i135.DeleteAccountCubit>(
        () => _i135.DeleteAccountCubit(gh<_i90.BaseRepositoryDeleteAccount>()));
    gh.factory<_i136.SearchByQrCubit>(
        () => _i136.SearchByQrCubit(gh<_i105.BaseRepositorySearchByQr>()));
    gh.singleton<_i137.BaseRepositoryQuraanVisitor>(
        () => _i138.QuraanRepositoryVisitorImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              quraanWebServiceVisitor: gh<_i18.QuraanWebServiceVisitor>(),
            ));
    gh.singleton<_i139.BaseRepositoryBase>(() => _i140.BaseRepositoryImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          baseWebService: gh<_i32.BaseWebService>(),
        ));
    gh.factory<_i141.GameVisitorCubit>(
        () => _i141.GameVisitorCubit(gh<_i69.BaseRepositoryGameVisitor>()));
    gh.singleton<_i142.BaseRepositorySearchResults>(
        () => _i143.SearchResultsRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              resultsWebService: gh<_i48.SearchResultsWebService>(),
            ));
    gh.singleton<_i144.BaseRepositorySectionVisitor>(
        () => _i145.SectionVisitorRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              sectionVisitorWebService: gh<_i21.SectionVisitorWebService>(),
            ));
    gh.singleton<_i146.BaseRepositoryAddtoCart>(
        () => _i147.AddtoCartRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              addtoCartWebService: gh<_i33.AddtoCartWebService>(),
            ));
    gh.factory<_i148.BaseCubit>(
        () => _i148.BaseCubit(gh<_i139.BaseRepositoryBase>()));
    gh.factory<_i149.AddtofavoriteCubit>(() =>
        _i149.AddtofavoriteCubit(gh<_i100.BaseRepositoryAddToFavorites>()));
    gh.factory<_i150.DetailsofofferCubit>(() =>
        _i150.DetailsofofferCubit(gh<_i81.BaseRepositoryDetailsofOffer>()));
    gh.factory<_i151.AddtocartCubit>(
        () => _i151.AddtocartCubit(gh<_i146.BaseRepositoryAddtoCart>()));
    gh.factory<_i152.TransferCubit>(
        () => _i152.TransferCubit(gh<_i126.BaseRepositoryTransfer>()));
    gh.singleton<_i153.BaseRepositoryGetNotifications>(
        () => _i154.GetNotificationsRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              getNotificationsWebService: gh<_i24.GetNotificationsWebService>(),
            ));
    gh.factory<_i155.CreateaccountCubit>(
        () => _i155.CreateaccountCubit(gh<_i50.BaseReposotryCreateAccount>()));
    gh.singleton<_i156.BaseRepositoryBookVisitor>(
        () => _i157.BookRepositoryVisitorImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              bookWebServiceVisitor: gh<_i35.BookWebServiceVisitor>(),
            ));
    gh.singleton<_i158.BaseRepositoryBaseVisitor>(
        () => _i159.BaseRepositoryVisitorImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              baseWebServiceVisitor: gh<_i20.BaseWebServiceVisitor>(),
            ));
    gh.singleton<_i160.BaseRepositoryGetUserInfo2>(
        () => _i161.GetUserInfo2RepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              getUserInfo2WebService: gh<_i64.GetUserInfo2WebService>(),
            ));
    gh.factory<_i162.BaseVisitorCubit>(
        () => _i162.BaseVisitorCubit(gh<_i158.BaseRepositoryBaseVisitor>()));
    gh.singleton<_i163.BaseRepositoryGetFavorites>(
        () => _i164.GetFavoritesRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              getFavoritesWebService: gh<_i60.GetFavoritesWebService>(),
            ));
    gh.singleton<_i165.BaseRepositoryNews>(() => _i166.NewsRepositoryImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          newsWebService: gh<_i31.NewsWebService>(),
        ));
    gh.singleton<_i167.BaseRepositoryGetOrders>(
        () => _i168.GetOrdersRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              getOrdersWebService: gh<_i75.GetOrdersWebService>(),
            ));
    gh.factory<_i169.LikeCubit>(
        () => _i169.LikeCubit(gh<_i55.BaseRepositoryLike>()));
    gh.factory<_i170.LoginCubit>(() => _i170.LoginCubit(
          gh<_i96.BaseReposotryLogin>(),
          gh<_i7.SharedPreferencesUtils>(),
        ));
    gh.factory<_i171.BookVisitorCubit>(
        () => _i171.BookVisitorCubit(gh<_i156.BaseRepositoryBookVisitor>()));
    gh.factory<_i172.OrderDetailsCubit>(
        () => _i172.OrderDetailsCubit(gh<_i88.BaseRepositoryOrderDetails>()));
    gh.factory<_i173.SendOrderCubit>(
        () => _i173.SendOrderCubit(gh<_i76.BaseRepositorySendOrder>()));
    gh.factory<_i174.GetproductsofsubsectionCubit>(() =>
        _i174.GetproductsofsubsectionCubit(
            gh<_i103.BaseRepositoryGetProductsOfSubSection>()));
    gh.singleton<_i175.BaseRepositoryBook>(() => _i176.Bookrepository(
          networkInfo: gh<_i8.NetworkInfo>(),
          bookWebService: gh<_i68.BookWebService>(),
        ));
    gh.factory<_i177.UpdateProfilePhotoCubit>(() =>
        _i177.UpdateProfilePhotoCubit(
            gh<_i129.BaseRepositoryUpdateProfilePhoto>()));
    gh.singleton<_i178.BaseRepositoryGetUserInfo>(
        () => _i179.GetUserInfoRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              getUserInfoWebService: gh<_i86.GetUserInfoWebService>(),
            ));
    gh.factory<_i180.GetUserInfo2Cubit>(
        () => _i180.GetUserInfo2Cubit(gh<_i160.BaseRepositoryGetUserInfo2>()));
    gh.singleton<_i181.BaseRepositoryRating>(() => _i182.RatingRepositoryImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          ratingWebService: gh<_i49.RatingWebService>(),
        ));
    gh.singleton<_i183.BaseRepositoryCreateVoucher>(
        () => _i184.CreateVoucherRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              createVoucherWebService: gh<_i61.CreateVoucherWebService>(),
            ));
    gh.factory<_i185.QuraanVisitorCubit>(() =>
        _i185.QuraanVisitorCubit(gh<_i137.BaseRepositoryQuraanVisitor>()));
    gh.factory<_i186.GetalloffersCubit>(
        () => _i186.GetalloffersCubit(gh<_i92.BaseRepositoryGetAllOffers>()));
    gh.factory<_i187.CartitemsCubit>(
        () => _i187.CartitemsCubit(gh<_i109.BaseRepositoryCartItems>()));
    gh.singleton<_i188.BaseRepositoryOnArrival>(
        () => _i189.OnArrivalRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              onArrivalWebService: gh<_i80.OnArrivalWebService>(),
            ));
    gh.factory<_i190.RatingCubit>(
        () => _i190.RatingCubit(gh<_i181.BaseRepositoryRating>()));
    gh.factory<_i191.StationeryCubit>(
        () => _i191.StationeryCubit(gh<_i114.BaseRepositoryStationery>()));
    gh.factory<_i192.DeleteitemfromcartCubit>(() =>
        _i192.DeleteitemfromcartCubit(
            gh<_i72.BaseRepositoryDeleteItemFromCart>()));
    gh.factory<_i193.GetOrdersCubit>(
        () => _i193.GetOrdersCubit(gh<_i167.BaseRepositoryGetOrders>()));
    gh.factory<_i194.OnArrivalCubit>(
        () => _i194.OnArrivalCubit(gh<_i188.BaseRepositoryOnArrival>()));
    gh.factory<_i195.SearchResultsCubit>(() =>
        _i195.SearchResultsCubit(gh<_i142.BaseRepositorySearchResults>()));
    gh.factory<_i196.SendOfferCubit>(
        () => _i196.SendOfferCubit(gh<_i94.BaseRepositorySendOffer>()));
    gh.factory<_i197.NewsCubit>(
        () => _i197.NewsCubit(gh<_i165.BaseRepositoryNews>()));
    gh.factory<_i198.GetCitiesCubit>(
        () => _i198.GetCitiesCubit(gh<_i112.BaseRepositoryGetCities>()));
    gh.factory<_i199.GetNotificationsCubit>(() => _i199.GetNotificationsCubit(
        gh<_i153.BaseRepositoryGetNotifications>()));
    gh.factory<_i200.SectionVisitorCubit>(() =>
        _i200.SectionVisitorCubit(gh<_i144.BaseRepositorySectionVisitor>()));
    gh.factory<_i201.QuraanCubit>(
        () => _i201.QuraanCubit(gh<_i131.BaseRepositoryQuraan>()));
    gh.factory<_i202.GetfavoritesCubit>(
        () => _i202.GetfavoritesCubit(gh<_i163.BaseRepositoryGetFavorites>()));
    gh.factory<_i203.StationeryVisitorCubit>(() => _i203.StationeryVisitorCubit(
        gh<_i124.BaseRepositoryStationeryVisitor>()));
    gh.factory<_i204.CreateVoucherCubit>(() =>
        _i204.CreateVoucherCubit(gh<_i183.BaseRepositoryCreateVoucher>()));
    gh.factory<_i205.GetUserInfoCubit>(
        () => _i205.GetUserInfoCubit(gh<_i178.BaseRepositoryGetUserInfo>()));
    gh.factory<_i206.BookCubit>(
        () => _i206.BookCubit(gh<_i175.BaseRepositoryBook>()));
    return this;
  }
}

class _$ThirdPartyInjection extends _i207.ThirdPartyInjection {}
