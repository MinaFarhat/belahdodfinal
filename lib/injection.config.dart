...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.singleton<_i11.CreateAccountWebService>(
        () => _i11.CreateAccountWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i12.BaseReposotryCreateAccount>(
        () => _i13.CreateAccountRepostryImpl(
