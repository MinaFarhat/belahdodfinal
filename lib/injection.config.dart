...
import 'Core/third_party_injection.dart' as _i159;
...
import 'Features/Auth/Create%20Account/Data/Web%20Service/createaccountwebservice.dart'
    as _i19;
import 'Features/Auth/Login/cubit/login_cubit.dart' as _i131;
...
import 'Features/Auth/Login/data/Web%20Service/loginwebservice.dart' as _i53;
...
import 'Features/User/Details/data/Web%20Service/book_webservice.dart' as _i55;
import 'Features/User/Details/data/Web%20Service/game_webservice.dart' as _i34;
import 'Features/User/Details/data/Web%20Service/likewebservice.dart' as _i40;
import 'Features/User/Details/data/Web%20Service/quraan_webservice.dart'
    as _i11;
import 'Features/User/Details/data/Web%20Service/ratingwebservice.dart' as _i43;
...
import 'Features/User/Details/Manager/Book%20Cubit/book_cubit.dart' as _i158;
import 'Features/User/Details/Manager/Game%20Cubit/game_cubit.dart' as _i89;
import 'Features/User/Details/Manager/Like%20Cubit/like_cubit.dart' as _i130;
...
import 'Features/User/news/Manager/Get%20All%20Offers%20Cubit/getalloffers_cubit.dart'
    as _i141;
import 'Features/User/news/Manager/News%20Cubit/news_cubit.dart' as _i151;
import 'Features/User/note/cubit/get_notifications_cubit.dart' as _i153;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.singleton<_i40.LikeWebService>(
        () => _i40.LikeWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i41.TransferWebService>(
        () => _i41.TransferWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i42.SearchResultsWebService>(
        () => _i42.SearchResultsWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i43.RatingWebService>(
        () => _i43.RatingWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i44.BaseReposotryCreateAccount>(
        () => _i45.CreateAccountRepostryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              accountWebService: gh<_i19.CreateAccountWebService>(),
            ));
    gh.singleton<_i46.QuantityUpdateWebService>(
        () => _i46.QuantityUpdateWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i47.BaseRepositoryLike>(() => _i48.LikeRepositoryImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          likeWebService: gh<_i40.LikeWebService>(),
        ));
    gh.singleton<_i49.GetFavoritesWebService>(
        () => _i49.GetFavoritesWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i50.BaseRepositoryQuantityUpdate>(
        () => _i51.QuantityUpdateRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              quantityUpdateWebService: gh<_i46.QuantityUpdateWebService>(),
            ));
    gh.singleton<_i52.StationeryWebService>(
        () => _i52.StationeryWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i53.LoginWebService>(
        () => _i53.LoginWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i54.CartItemsWebService>(
        () => _i54.CartItemsWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i55.BookWebService>(
        () => _i55.BookWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i56.BaseRepositoryGameVisitor>(
        () => _i57.GameRepositoryVisitorImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              gameWebServiceVisitor: gh<_i33.GameWebServiceVisitor>(),
            ));
    gh.singleton<_i58.BaseRepositoryDeleteItemFromCart>(() =>
        _i59.DeleteItemFromCartRepositoryImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          deleteItemFromCartWebService: gh<_i24.DeleteItemFromCartWebService>(),
        ));
    gh.singleton<_i60.AddToFavoritesWebService>(
        () => _i60.AddToFavoriteWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i61.GetOrdersWebService>(
        () => _i61.GetOrdersWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i62.BaseRepositorySendOrder>(
        () => _i63.SendOrderRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              sendOrderWebService: gh<_i22.SendOrderWebService>(),
            ));
    gh.singleton<_i64.GetAllOffersWebService>(
        () => _i64.GetAllOffersWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.factory<_i65.GetProductsMainSectionCubit>(() =>
        _i65.GetProductsMainSectionCubit(
            gh<_i37.BaseRepositoryGetProductsMainSection>()));
    gh.singleton<_i66.OnArrivalWebService>(
        () => _i66.OnArrivalWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i67.BaseRepositoryDetailsofOffer>(
        () => _i68.DetailsofOfferRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              detailsofOfferWebService: gh<_i35.DetailsofOfferWebService>(),
            ));
    gh.singleton<_i69.GetCitiesWebService>(
        () => _i69.GetCitiesWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i70.BaseRepositoryOrderDetails>(
        () => _i71.OrderDetailsRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
    ...
    gh.singleton<_i72.BaseRepositoryGetAllOffers>(
        () => _i73.GetAllOffersRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              getAllOffersWebService: gh<_i64.GetAllOffersWebService>(),
            ));
    gh.singleton<_i74.BaseReposotryLogin>(() => _i75.LoginReposotryImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          loginWebService: gh<_i53.LoginWebService>(),
        ));
    gh.singleton<_i76.BaseRepositoryAddToFavorites>(
        () => _i77.AddToFavoritesRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              addToFavoriteWebService: gh<_i60.AddToFavoritesWebService>(),
            ));
    ...
    gh.singleton<_i82.BaseRepositoryCartItems>(
        () => _i83.GetCartItemsRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              cartItemsWebService: gh<_i54.CartItemsWebService>(),
            ));
    ...
    gh.singleton<_i85.BaseRepositoryGetCities>(
        () => _i86.GetCitiesRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              getCitiesWebService: gh<_i69.GetCitiesWebService>(),
            ));
    gh.singleton<_i87.BaseRepositoryStationery>(() => _i88.StationeryRepository(
          networkInfo: gh<_i8.NetworkInfo>(),
          stationeryWebService: gh<_i52.StationeryWebService>(),
        ));
    ...
    gh.singleton<_i94.BaseRepositoryTransfer>(() => _i95.TransferRepositoryImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          transferWebService: gh<_i41.TransferWebService>(),
        ));
    gh.factory<_i96.QuantitiyupdateCubit>(() =>
        _i96.QuantitiyupdateCubit(gh<_i50.BaseRepositoryQuantityUpdate>()));
    ...
    gh.factory<_i104.GameVisitorCubit>(
        () => _i104.GameVisitorCubit(gh<_i56.BaseRepositoryGameVisitor>()));
    gh.singleton<_i105.BaseRepositorySearchResults>(
        () => _i106.SearchResultsRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              resultsWebService: gh<_i42.SearchResultsWebService>(),
            ));
    ...
    gh.factory<_i113.DetailsofofferCubit>(() =>
        _i113.DetailsofofferCubit(gh<_i67.BaseRepositoryDetailsofOffer>()));
    ...
    gh.factory<_i118.CreateaccountCubit>(
        () => _i118.CreateaccountCubit(gh<_i44.BaseReposotryCreateAccount>()));
    ...
    gh.singleton<_i124.BaseRepositoryGetFavorites>(
        () => _i125.GetFavoritesRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              getFavoritesWebService: gh<_i49.GetFavoritesWebService>(),
            ));
    ...
    gh.singleton<_i128.BaseRepositoryGetOrders>(
        () => _i129.GetOrdersRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              getOrdersWebService: gh<_i61.GetOrdersWebService>(),
            ));
    gh.factory<_i130.LikeCubit>(
        () => _i130.LikeCubit(gh<_i47.BaseRepositoryLike>()));
    gh.factory<_i131.LoginCubit>(() => _i131.LoginCubit(
          gh<_i74.BaseReposotryLogin>(),
          gh<_i7.SharedPreferencesUtils>(),
        ));
    gh.factory<_i132.BookVisitorCubit>(
        () => _i132.BookVisitorCubit(gh<_i119.BaseRepositoryBookVisitor>()));
    gh.factory<_i133.OrderDetailsCubit>(
        () => _i133.OrderDetailsCubit(gh<_i70.BaseRepositoryOrderDetails>()));
    gh.factory<_i134.SendOrderCubit>(
        () => _i134.SendOrderCubit(gh<_i62.BaseRepositorySendOrder>()));
    gh.factory<_i135.GetproductsofsubsectionCubit>(() =>
        _i135.GetproductsofsubsectionCubit(
            gh<_i78.BaseRepositoryGetProductsOfSubSection>()));
    gh.singleton<_i136.BaseRepositoryBook>(() => _i137.Bookrepository(
          networkInfo: gh<_i8.NetworkInfo>(),
          bookWebService: gh<_i55.BookWebService>(),
        ));
    gh.singleton<_i138.BaseRepositoryRating>(() => _i139.RatingRepositoryImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          ratingWebService: gh<_i43.RatingWebService>(),
        ));
    gh.factory<_i140.QuraanVisitorCubit>(() =>
        _i140.QuraanVisitorCubit(gh<_i100.BaseRepositoryQuraanVisitor>()));
    gh.factory<_i141.GetalloffersCubit>(
        () => _i141.GetalloffersCubit(gh<_i72.BaseRepositoryGetAllOffers>()));
    gh.factory<_i142.CartitemsCubit>(
        () => _i142.CartitemsCubit(gh<_i82.BaseRepositoryCartItems>()));
    gh.singleton<_i143.BaseRepositoryOnArrival>(
        () => _i144.OnArrivalRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              onArrivalWebService: gh<_i66.OnArrivalWebService>(),
            ));
    gh.factory<_i145.RatingCubit>(
        () => _i145.RatingCubit(gh<_i138.BaseRepositoryRating>()));
    gh.factory<_i146.StationeryCubit>(
        () => _i146.StationeryCubit(gh<_i87.BaseRepositoryStationery>()));
    gh.factory<_i147.DeleteitemfromcartCubit>(() =>
        _i147.DeleteitemfromcartCubit(
            gh<_i58.BaseRepositoryDeleteItemFromCart>()));
    gh.factory<_i148.GetOrdersCubit>(
        () => _i148.GetOrdersCubit(gh<_i128.BaseRepositoryGetOrders>()));
    gh.factory<_i149.OnArrivalCubit>(
        () => _i149.OnArrivalCubit(gh<_i143.BaseRepositoryOnArrival>()));
    gh.factory<_i150.SearchResultsCubit>(() =>
        _i150.SearchResultsCubit(gh<_i105.BaseRepositorySearchResults>()));
    gh.factory<_i151.NewsCubit>(
        () => _i151.NewsCubit(gh<_i126.BaseRepositoryNews>()));
    gh.factory<_i152.GetCitiesCubit>(
        () => _i152.GetCitiesCubit(gh<_i85.BaseRepositoryGetCities>()));
    gh.factory<_i153.GetNotificationsCubit>(() => _i153.GetNotificationsCubit(
        gh<_i116.BaseRepositoryGetNotifications>()));
    gh.factory<_i154.SectionVisitorCubit>(() =>
        _i154.SectionVisitorCubit(gh<_i107.BaseRepositorySectionVisitor>()));
    gh.factory<_i155.QuraanCubit>(
        () => _i155.QuraanCubit(gh<_i97.BaseRepositoryQuraan>()));
    gh.factory<_i156.GetfavoritesCubit>(
        () => _i156.GetfavoritesCubit(gh<_i124.BaseRepositoryGetFavorites>()));
    gh.factory<_i157.StationeryVisitorCubit>(() => _i157.StationeryVisitorCubit(
        gh<_i92.BaseRepositoryStationeryVisitor>()));
    gh.factory<_i158.BookCubit>(
        () => _i158.BookCubit(gh<_i136.BaseRepositoryBook>()));
    return this;
  }
}

class _$ThirdPartyInjection extends _i159.ThirdPartyInjection {}
