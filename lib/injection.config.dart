...
import 'Core/third_party_injection.dart' as _i171;
import 'Core/utils/shared_preference_utils.dart' as _i7;
import 'Features/Auth/Create%20Account/cubit/createaccount_cubit.dart' as _i130;
...
import 'Features/Auth/Create%20Account/Data/Web%20Service/createaccountwebservice.dart'
    as _i20;
import 'Features/Auth/Login/cubit/login_cubit.dart' as _i143;
import 'Features/Auth/Login/data/Repostry/basereposotrylogin.dart' as _i79;
import 'Features/Auth/Login/data/Repostry/loginreposotry.dart' as _i80;
...
import 'Features/User/Details/data/Web%20Service/stationery_webservice.dart'
    as _i57;
import 'Features/User/Details/Manager/Base%20Cubit/base_cubit.dart' as _i123;
import 'Features/User/Details/Manager/Book%20Cubit/book_cubit.dart' as _i170;
import 'Features/User/Details/Manager/DisLike%20Cubit/dis_like_cubit.dart'
    as _i111;
import 'Features/User/Details/Manager/Game%20Cubit/game_cubit.dart' as _i97;
import 'Features/User/Details/Manager/Like%20Cubit/like_cubit.dart' as _i142;
...
import 'Features/User/favorite/Manager/Get%20Favorites%20Cubit/getfavorites_cubit.dart'
    as _i168;
import 'Features/User/homepage/HomeScreen/cubit/section_cubit.dart' as _i110;
...
import 'Features/User/news/data/Repostry/News/baserepositorymewdetails.dart'
    as _i81;
import 'Features/User/news/data/Repostry/News/baserepositorynews.dart' as _i138;
import 'Features/User/news/data/Repostry/News/newdetailsrepository.dart'
    as _i82;
import 'Features/User/news/data/Repostry/News/newsrepository.dart' as _i139;
...
import 'Features/User/news/Manager/New%20Details%20Cubit/new_details_cubit.dart'
    as _i85;
import 'Features/User/news/Manager/News%20Cubit/news_cubit.dart' as _i163;
import 'Features/User/note/cubit/get_notifications_cubit.dart' as _i165;
import 'Features/User/note/data/Repostry/baserepositorygetnotifications.dart'
    as _i128;
import 'Features/User/note/data/Repostry/getnotificationsentity.dart' as _i129;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.singleton<_i75.BaseRepositoryOrderDetails>(
        () => _i76.OrderDetailsRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              orderDetailsWebService: gh<_i21.OrderDetailsWebService>(),
            ));
    gh.singleton<_i77.BaseRepositoryGetAllOffers>(
        () => _i78.GetAllOffersRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              getAllOffersWebService: gh<_i69.GetAllOffersWebService>(),
            ));
    gh.singleton<_i79.BaseReposotryLogin>(() => _i80.LoginReposotryImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          loginWebService: gh<_i58.LoginWebService>(),
        ));
    gh.singleton<_i81.BaseRepositoryNewDetails>(
        () => _i82.NewDetailsRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              newDetailsWebService: gh<_i32.NewDetailsWebService>(),
            ));
    gh.singleton<_i83.BaseRepositoryAddToFavorites>(
        () => _i84.AddToFavoritesRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              addToFavoriteWebService: gh<_i65.AddToFavoritesWebService>(),
            ));
    gh.factory<_i85.NewDetailsCubit>(
        () => _i85.NewDetailsCubit(gh<_i81.BaseRepositoryNewDetails>()));
    gh.singleton<_i86.BaseRepositoryGetProductsOfSubSection>(
        () => _i87.GetProductsofSubSectionRepository(
              networkInfo: gh<_i8.NetworkInfo>(),
              getProductsofSubSectionWebService:
                  gh<_i39.GetProductsofSubSectionWebService>(),
            ));
    gh.singleton<_i88.BaseRepositoryGame>(() => _i89.GameRepository(
          networkInfo: gh<_i8.NetworkInfo>(),
          gameWebService: gh<_i37.GameWebService>(),
        ));
    gh.singleton<_i90.BaseRepositoryCartItems>(
        () => _i91.GetCartItemsRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              cartItemsWebService: gh<_i59.CartItemsWebService>(),
            ));
    gh.factory<_i92.GetsubsectionsCubit>(() =>
        _i92.GetsubsectionsCubit(gh<_i34.BaseRepositoryGetSubSections>()));
    gh.singleton<_i93.BaseRepositoryGetCities>(
        () => _i94.GetCitiesRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              getCitiesWebService: gh<_i74.GetCitiesWebService>(),
            ));
    gh.singleton<_i95.BaseRepositoryStationery>(() => _i96.StationeryRepository(
          networkInfo: gh<_i8.NetworkInfo>(),
          stationeryWebService: gh<_i57.StationeryWebService>(),
        ));
    gh.factory<_i97.GameCubit>(
        () => _i97.GameCubit(gh<_i88.BaseRepositoryGame>()));
    gh.singleton<_i98.BaseRepositorySection>(() => _i99.SectionRepositoryImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          sectionWebService: gh<_i16.SectionWebService>(),
        ));
    gh.singleton<_i100.BaseRepositoryDisLike>(() => _i101.DisLikeRepositoryImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          disLikeWebService: gh<_i15.DisLikeWebService>(),
        ));
    gh.factory<_i102.PopularProductsCubit>(() =>
        _i102.PopularProductsCubit(gh<_i52.BaseRepositoryPopularProducts>()));
    gh.singleton<_i103.BaseRepositoryStationeryVisitor>(() =>
        _i104.StationeryRepositoryVisitorImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          stationeryWebServiceVisitor: gh<_i12.StationeryWebServiceVisitor>(),
        ));
    gh.singleton<_i105.BaseRepositoryTransfer>(
        () => _i106.TransferRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              transferWebService: gh<_i44.TransferWebService>(),
            ));
    gh.factory<_i107.QuantitiyupdateCubit>(() =>
        _i107.QuantitiyupdateCubit(gh<_i55.BaseRepositoryQuantityUpdate>()));
    gh.singleton<_i108.BaseRepositoryQuraan>(() => _i109.QuraanRepository(
          networkInfo: gh<_i8.NetworkInfo>(),
          quraanWebService: gh<_i11.QuraanWebService>(),
        ));
    gh.factory<_i110.SectionCubit>(
        () => _i110.SectionCubit(gh<_i98.BaseRepositorySection>()));
    gh.factory<_i111.DisLikeCubit>(
        () => _i111.DisLikeCubit(gh<_i100.BaseRepositoryDisLike>()));
    gh.singleton<_i112.BaseRepositoryQuraanVisitor>(
        () => _i113.QuraanRepositoryVisitorImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              quraanWebServiceVisitor: gh<_i17.QuraanWebServiceVisitor>(),
            ));
    gh.singleton<_i114.BaseRepositoryBase>(() => _i115.BaseRepositoryImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          baseWebService: gh<_i30.BaseWebService>(),
        ));
    gh.factory<_i116.GameVisitorCubit>(
        () => _i116.GameVisitorCubit(gh<_i61.BaseRepositoryGameVisitor>()));
    gh.singleton<_i117.BaseRepositorySearchResults>(
        () => _i118.SearchResultsRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              resultsWebService: gh<_i45.SearchResultsWebService>(),
            ));
    gh.singleton<_i119.BaseRepositorySectionVisitor>(
        () => _i120.SectionVisitorRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              sectionVisitorWebService: gh<_i19.SectionVisitorWebService>(),
            ));
    gh.singleton<_i121.BaseRepositoryAddtoCart>(
        () => _i122.AddtoCartRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              addtoCartWebService: gh<_i31.AddtoCartWebService>(),
            ));
    gh.factory<_i123.BaseCubit>(
        () => _i123.BaseCubit(gh<_i114.BaseRepositoryBase>()));
    gh.factory<_i124.AddtofavoriteCubit>(() =>
        _i124.AddtofavoriteCubit(gh<_i83.BaseRepositoryAddToFavorites>()));
    gh.factory<_i125.DetailsofofferCubit>(() =>
        _i125.DetailsofofferCubit(gh<_i72.BaseRepositoryDetailsofOffer>()));
    gh.factory<_i126.AddtocartCubit>(
        () => _i126.AddtocartCubit(gh<_i121.BaseRepositoryAddtoCart>()));
    gh.factory<_i127.TransferCubit>(
        () => _i127.TransferCubit(gh<_i105.BaseRepositoryTransfer>()));
    gh.singleton<_i128.BaseRepositoryGetNotifications>(
        () => _i129.GetNotificationsRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              getNotificationsWebService: gh<_i22.GetNotificationsWebService>(),
            ));
    gh.factory<_i130.CreateaccountCubit>(
        () => _i130.CreateaccountCubit(gh<_i47.BaseReposotryCreateAccount>()));
    gh.singleton<_i131.BaseRepositoryBookVisitor>(
        () => _i132.BookRepositoryVisitorImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              bookWebServiceVisitor: gh<_i33.BookWebServiceVisitor>(),
            ));
    gh.singleton<_i133.BaseRepositoryBaseVisitor>(
        () => _i134.BaseRepositoryVisitorImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              baseWebServiceVisitor: gh<_i18.BaseWebServiceVisitor>(),
            ));
    gh.factory<_i135.BaseVisitorCubit>(
        () => _i135.BaseVisitorCubit(gh<_i133.BaseRepositoryBaseVisitor>()));
    gh.singleton<_i136.BaseRepositoryGetFavorites>(
        () => _i137.GetFavoritesRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              getFavoritesWebService: gh<_i54.GetFavoritesWebService>(),
            ));
    gh.singleton<_i138.BaseRepositoryNews>(() => _i139.NewsRepositoryImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          newsWebService: gh<_i29.NewsWebService>(),
        ));
    gh.singleton<_i140.BaseRepositoryGetOrders>(
        () => _i141.GetOrdersRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              getOrdersWebService: gh<_i66.GetOrdersWebService>(),
            ));
    gh.factory<_i142.LikeCubit>(
        () => _i142.LikeCubit(gh<_i50.BaseRepositoryLike>()));
    gh.factory<_i143.LoginCubit>(() => _i143.LoginCubit(
          gh<_i79.BaseReposotryLogin>(),
          gh<_i7.SharedPreferencesUtils>(),
        ));
    gh.factory<_i144.BookVisitorCubit>(
        () => _i144.BookVisitorCubit(gh<_i131.BaseRepositoryBookVisitor>()));
    gh.factory<_i145.OrderDetailsCubit>(
        () => _i145.OrderDetailsCubit(gh<_i75.BaseRepositoryOrderDetails>()));
    gh.factory<_i146.SendOrderCubit>(
        () => _i146.SendOrderCubit(gh<_i67.BaseRepositorySendOrder>()));
    gh.factory<_i147.GetproductsofsubsectionCubit>(() =>
        _i147.GetproductsofsubsectionCubit(
            gh<_i86.BaseRepositoryGetProductsOfSubSection>()));
    gh.singleton<_i148.BaseRepositoryBook>(() => _i149.Bookrepository(
          networkInfo: gh<_i8.NetworkInfo>(),
          bookWebService: gh<_i60.BookWebService>(),
        ));
    gh.singleton<_i150.BaseRepositoryRating>(() => _i151.RatingRepositoryImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          ratingWebService: gh<_i46.RatingWebService>(),
        ));
    gh.factory<_i152.QuraanVisitorCubit>(() =>
        _i152.QuraanVisitorCubit(gh<_i112.BaseRepositoryQuraanVisitor>()));
    gh.factory<_i153.GetalloffersCubit>(
        () => _i153.GetalloffersCubit(gh<_i77.BaseRepositoryGetAllOffers>()));
    gh.factory<_i154.CartitemsCubit>(
        () => _i154.CartitemsCubit(gh<_i90.BaseRepositoryCartItems>()));
    gh.singleton<_i155.BaseRepositoryOnArrival>(
        () => _i156.OnArrivalRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              onArrivalWebService: gh<_i71.OnArrivalWebService>(),
            ));
    gh.factory<_i157.RatingCubit>(
        () => _i157.RatingCubit(gh<_i150.BaseRepositoryRating>()));
    gh.factory<_i158.StationeryCubit>(
        () => _i158.StationeryCubit(gh<_i95.BaseRepositoryStationery>()));
    gh.factory<_i159.DeleteitemfromcartCubit>(() =>
        _i159.DeleteitemfromcartCubit(
            gh<_i63.BaseRepositoryDeleteItemFromCart>()));
    gh.factory<_i160.GetOrdersCubit>(
        () => _i160.GetOrdersCubit(gh<_i140.BaseRepositoryGetOrders>()));
    gh.factory<_i161.OnArrivalCubit>(
        () => _i161.OnArrivalCubit(gh<_i155.BaseRepositoryOnArrival>()));
    gh.factory<_i162.SearchResultsCubit>(() =>
        _i162.SearchResultsCubit(gh<_i117.BaseRepositorySearchResults>()));
    gh.factory<_i163.NewsCubit>(
        () => _i163.NewsCubit(gh<_i138.BaseRepositoryNews>()));
    gh.factory<_i164.GetCitiesCubit>(
        () => _i164.GetCitiesCubit(gh<_i93.BaseRepositoryGetCities>()));
    gh.factory<_i165.GetNotificationsCubit>(() => _i165.GetNotificationsCubit(
        gh<_i128.BaseRepositoryGetNotifications>()));
    gh.factory<_i166.SectionVisitorCubit>(() =>
        _i166.SectionVisitorCubit(gh<_i119.BaseRepositorySectionVisitor>()));
    gh.factory<_i167.QuraanCubit>(
        () => _i167.QuraanCubit(gh<_i108.BaseRepositoryQuraan>()));
    gh.factory<_i168.GetfavoritesCubit>(
        () => _i168.GetfavoritesCubit(gh<_i136.BaseRepositoryGetFavorites>()));
    gh.factory<_i169.StationeryVisitorCubit>(() => _i169.StationeryVisitorCubit(
        gh<_i103.BaseRepositoryStationeryVisitor>()));
    gh.factory<_i170.BookCubit>(
        () => _i170.BookCubit(gh<_i148.BaseRepositoryBook>()));
    return this;
  }
}

class _$ThirdPartyInjection extends _i171.ThirdPartyInjection {}
