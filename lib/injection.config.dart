...
import 'Core/third_party_injection.dart' as _i215;
import 'Core/utils/shared_preference_utils.dart' as _i7;
import 'Features/Auth/Create%20Account/cubit/createaccount_cubit.dart' as _i162;
...
import 'Features/Auth/Create%20Account/Data/Web%20Service/createaccountwebservice.dart'
    as _i22;
import 'Features/Auth/Login/cubit/login_cubit.dart' as _i178;
import 'Features/Auth/Login/data/Repostry/basereposotrylogin.dart' as _i100;
import 'Features/Auth/Login/data/Repostry/loginreposotry.dart' as _i101;
...
import 'Features/User/Details/data/Web%20Service/stationery_webservice.dart'
    as _i65;
import 'Features/User/Details/Manager/Base%20Cubit/base_cubit.dart' as _i154;
import 'Features/User/Details/Manager/Book%20Cubit/book_cubit.dart' as _i214;
import 'Features/User/Details/Manager/DisLike%20Cubit/dis_like_cubit.dart'
    as _i140;
import 'Features/User/Details/Manager/Game%20Cubit/game_cubit.dart' as _i123;
import 'Features/User/Details/Manager/Like%20Cubit/like_cubit.dart' as _i177;
...
import 'Features/User/favorite/Manager/Get%20Favorites%20Cubit/getfavorites_cubit.dart'
    as _i210;
import 'Features/User/homepage/HomeScreen/cubit/section_cubit.dart' as _i139;
...
import 'Features/User/news/data/Repostry/News/baserepositorymewdetails.dart'
    as _i102;
import 'Features/User/news/data/Repostry/News/baserepositorynews.dart' as _i172;
import 'Features/User/news/data/Repostry/News/newdetailsrepository.dart'
    as _i103;
import 'Features/User/news/data/Repostry/News/newsrepository.dart' as _i173;
...
import 'Features/User/news/Manager/New%20Details%20Cubit/new_details_cubit.dart'
    as _i106;
import 'Features/User/news/Manager/News%20Cubit/news_cubit.dart' as _i205;
import 'Features/User/note/cubit/get_notifications_cubit.dart' as _i207;
import 'Features/User/note/data/Repostry/baserepositorygetnotifications.dart'
    as _i160;
import 'Features/User/note/data/Repostry/getnotificationsentity.dart' as _i161;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.singleton<_i85.WalletWebService>(
        () => _i85.WalletWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i86.BaseRepositoryCheckBalance>(
        () => _i87.CheckBalanceRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              checkBalanceWebService: gh<_i79.CheckBalanceWebService>(),
            ));
    gh.singleton<_i88.BaseRepositoryUpdateUserInfo>(
        () => _i89.UpdateUserInfoRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              updateUserInfoWebService: gh<_i71.UpdateUserInfoWebService>(),
            ));
    gh.singleton<_i90.GetUserInfoWebService>(
        () => _i90.GetUserInfoWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i91.SearchByQrWebService>(
        () => _i91.SearchByQrWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i92.BaseRepositoryOrderDetails>(
        () => _i93.OrderDetailsRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              orderDetailsWebService: gh<_i23.OrderDetailsWebService>(),
            ));
    gh.singleton<_i94.BaseRepositoryDeleteAccount>(
        () => _i95.DeleteAccountRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              deleteAccountWebService: gh<_i45.DeleteAccountWebService>(),
            ));
    gh.singleton<_i96.BaseRepositoryGetAllOffers>(
        () => _i97.GetAllOffersRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              getAllOffersWebService: gh<_i78.GetAllOffersWebService>(),
            ));
    gh.singleton<_i98.BaseRepositorySendOffer>(
        () => _i99.SendOfferRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              sendOfferWebService: gh<_i59.SendOfferWebService>(),
            ));
    gh.singleton<_i100.BaseReposotryLogin>(() => _i101.LoginReposotryImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          loginWebService: gh<_i66.LoginWebService>(),
        ));
    gh.singleton<_i102.BaseRepositoryNewDetails>(
        () => _i103.NewDetailsRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              newDetailsWebService: gh<_i34.NewDetailsWebService>(),
            ));
    gh.singleton<_i104.BaseRepositoryAddToFavorites>(
        () => _i105.AddToFavoritesRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              addToFavoriteWebService: gh<_i74.AddToFavoritesWebService>(),
            ));
    gh.factory<_i106.NewDetailsCubit>(
        () => _i106.NewDetailsCubit(gh<_i102.BaseRepositoryNewDetails>()));
    gh.singleton<_i107.BaseRepositoryWallet>(() => _i108.WalletRepositoryImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          walletWebService: gh<_i85.WalletWebService>(),
        ));
    gh.singleton<_i109.BaseRepositoryGetProductsOfSubSection>(
        () => _i110.GetProductsofSubSectionRepository(
              networkInfo: gh<_i8.NetworkInfo>(),
              getProductsofSubSectionWebService:
                  gh<_i41.GetProductsofSubSectionWebService>(),
            ));
    gh.singleton<_i111.BaseRepositorySearchByQr>(
        () => _i112.SearchByQrRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              searchByQrWebService: gh<_i91.SearchByQrWebService>(),
            ));
    gh.singleton<_i113.BaseRepositoryGame>(() => _i114.GameRepository(
          networkInfo: gh<_i8.NetworkInfo>(),
          gameWebService: gh<_i39.GameWebService>(),
        ));
    gh.singleton<_i115.BaseRepositoryCartItems>(
        () => _i116.GetCartItemsRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              cartItemsWebService: gh<_i67.CartItemsWebService>(),
            ));
    gh.factory<_i117.GetsubsectionsCubit>(() =>
        _i117.GetsubsectionsCubit(gh<_i36.BaseRepositoryGetSubSections>()));
    gh.singleton<_i118.BaseRepositoryGetCities>(
        () => _i119.GetCitiesRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              getCitiesWebService: gh<_i84.GetCitiesWebService>(),
            ));
    gh.singleton<_i120.BaseRepositoryStationery>(
        () => _i121.StationeryRepository(
              networkInfo: gh<_i8.NetworkInfo>(),
              stationeryWebService: gh<_i65.StationeryWebService>(),
            ));
    gh.factory<_i122.UpdateUserInfoCubit>(() =>
        _i122.UpdateUserInfoCubit(gh<_i88.BaseRepositoryUpdateUserInfo>()));
    gh.factory<_i123.GameCubit>(
        () => _i123.GameCubit(gh<_i113.BaseRepositoryGame>()));
    gh.singleton<_i124.BaseRepositorySection>(() => _i125.SectionRepositoryImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          sectionWebService: gh<_i16.SectionWebService>(),
        ));
    gh.singleton<_i126.BaseRepositoryDisLike>(() => _i127.DisLikeRepositoryImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          disLikeWebService: gh<_i15.DisLikeWebService>(),
        ));
    gh.factory<_i128.GetVouchersCubit>(
        () => _i128.GetVouchersCubit(gh<_i53.BaseRepositoryGetVouchers>()));
    gh.factory<_i129.PopularProductsCubit>(() =>
        _i129.PopularProductsCubit(gh<_i57.BaseRepositoryPopularProducts>()));
    gh.singleton<_i130.BaseRepositoryStationeryVisitor>(() =>
        _i131.StationeryRepositoryVisitorImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          stationeryWebServiceVisitor: gh<_i12.StationeryWebServiceVisitor>(),
        ));
    gh.singleton<_i132.BaseRepositoryTransfer>(
        () => _i133.TransferRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              transferWebService: gh<_i47.TransferWebService>(),
            ));
    gh.factory<_i134.QuantitiyupdateCubit>(() =>
        _i134.QuantitiyupdateCubit(gh<_i62.BaseRepositoryQuantityUpdate>()));
    gh.singleton<_i135.BaseRepositoryUpdateProfilePhoto>(() =>
        _i136.UpdateProfilePhotoRepositoryImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          updateProfilePhotoWebService: gh<_i17.UpdateProfilePhotoWebService>(),
        ));
    gh.singleton<_i137.BaseRepositoryQuraan>(() => _i138.QuraanRepository(
          networkInfo: gh<_i8.NetworkInfo>(),
          quraanWebService: gh<_i11.QuraanWebService>(),
        ));
    gh.factory<_i139.SectionCubit>(
        () => _i139.SectionCubit(gh<_i124.BaseRepositorySection>()));
    gh.factory<_i140.DisLikeCubit>(
        () => _i140.DisLikeCubit(gh<_i126.BaseRepositoryDisLike>()));
    gh.factory<_i141.DeleteAccountCubit>(
        () => _i141.DeleteAccountCubit(gh<_i94.BaseRepositoryDeleteAccount>()));
    gh.factory<_i142.SearchByQrCubit>(
        () => _i142.SearchByQrCubit(gh<_i111.BaseRepositorySearchByQr>()));
    gh.singleton<_i143.BaseRepositoryQuraanVisitor>(
        () => _i144.QuraanRepositoryVisitorImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              quraanWebServiceVisitor: gh<_i18.QuraanWebServiceVisitor>(),
            ));
    gh.singleton<_i145.BaseRepositoryBase>(() => _i146.BaseRepositoryImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          baseWebService: gh<_i32.BaseWebService>(),
        ));
    gh.factory<_i147.GameVisitorCubit>(
        () => _i147.GameVisitorCubit(gh<_i69.BaseRepositoryGameVisitor>()));
    gh.singleton<_i148.BaseRepositorySearchResults>(
        () => _i149.SearchResultsRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              resultsWebService: gh<_i48.SearchResultsWebService>(),
            ));
    gh.singleton<_i150.BaseRepositorySectionVisitor>(
        () => _i151.SectionVisitorRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              sectionVisitorWebService: gh<_i21.SectionVisitorWebService>(),
            ));
    gh.singleton<_i152.BaseRepositoryAddtoCart>(
        () => _i153.AddtoCartRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              addtoCartWebService: gh<_i33.AddtoCartWebService>(),
            ));
    gh.factory<_i154.BaseCubit>(
        () => _i154.BaseCubit(gh<_i145.BaseRepositoryBase>()));
    gh.factory<_i155.AddtofavoriteCubit>(() =>
        _i155.AddtofavoriteCubit(gh<_i104.BaseRepositoryAddToFavorites>()));
    gh.factory<_i156.DetailsofofferCubit>(() =>
        _i156.DetailsofofferCubit(gh<_i82.BaseRepositoryDetailsofOffer>()));
    gh.factory<_i157.AddtocartCubit>(
        () => _i157.AddtocartCubit(gh<_i152.BaseRepositoryAddtoCart>()));
    gh.factory<_i158.WalletCubit>(
        () => _i158.WalletCubit(gh<_i107.BaseRepositoryWallet>()));
    gh.factory<_i159.TransferCubit>(
        () => _i159.TransferCubit(gh<_i132.BaseRepositoryTransfer>()));
    gh.singleton<_i160.BaseRepositoryGetNotifications>(
        () => _i161.GetNotificationsRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              getNotificationsWebService: gh<_i24.GetNotificationsWebService>(),
            ));
    gh.factory<_i162.CreateaccountCubit>(
        () => _i162.CreateaccountCubit(gh<_i50.BaseReposotryCreateAccount>()));
    gh.singleton<_i163.BaseRepositoryBookVisitor>(
        () => _i164.BookRepositoryVisitorImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              bookWebServiceVisitor: gh<_i35.BookWebServiceVisitor>(),
            ));
    gh.singleton<_i165.BaseRepositoryBaseVisitor>(
        () => _i166.BaseRepositoryVisitorImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              baseWebServiceVisitor: gh<_i20.BaseWebServiceVisitor>(),
            ));
    gh.singleton<_i167.BaseRepositoryGetUserInfo2>(
        () => _i168.GetUserInfo2RepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              getUserInfo2WebService: gh<_i64.GetUserInfo2WebService>(),
            ));
    gh.factory<_i169.BaseVisitorCubit>(
        () => _i169.BaseVisitorCubit(gh<_i165.BaseRepositoryBaseVisitor>()));
    gh.singleton<_i170.BaseRepositoryGetFavorites>(
        () => _i171.GetFavoritesRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              getFavoritesWebService: gh<_i60.GetFavoritesWebService>(),
            ));
    gh.singleton<_i172.BaseRepositoryNews>(() => _i173.NewsRepositoryImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          newsWebService: gh<_i31.NewsWebService>(),
        ));
    gh.singleton<_i174.BaseRepositoryGetOrders>(
        () => _i175.GetOrdersRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              getOrdersWebService: gh<_i75.GetOrdersWebService>(),
            ));
    gh.factory<_i176.CheckBalanceCubit>(
        () => _i176.CheckBalanceCubit(gh<_i86.BaseRepositoryCheckBalance>()));
    gh.factory<_i177.LikeCubit>(
        () => _i177.LikeCubit(gh<_i55.BaseRepositoryLike>()));
    gh.factory<_i178.LoginCubit>(() => _i178.LoginCubit(
          gh<_i100.BaseReposotryLogin>(),
          gh<_i7.SharedPreferencesUtils>(),
        ));
    gh.factory<_i179.BookVisitorCubit>(
        () => _i179.BookVisitorCubit(gh<_i163.BaseRepositoryBookVisitor>()));
    gh.factory<_i180.OrderDetailsCubit>(
        () => _i180.OrderDetailsCubit(gh<_i92.BaseRepositoryOrderDetails>()));
    gh.factory<_i181.SendOrderCubit>(
        () => _i181.SendOrderCubit(gh<_i76.BaseRepositorySendOrder>()));
    gh.factory<_i182.GetproductsofsubsectionCubit>(() =>
        _i182.GetproductsofsubsectionCubit(
            gh<_i109.BaseRepositoryGetProductsOfSubSection>()));
    gh.singleton<_i183.BaseRepositoryBook>(() => _i184.Bookrepository(
          networkInfo: gh<_i8.NetworkInfo>(),
          bookWebService: gh<_i68.BookWebService>(),
        ));
    gh.factory<_i185.UpdateProfilePhotoCubit>(() =>
        _i185.UpdateProfilePhotoCubit(
            gh<_i135.BaseRepositoryUpdateProfilePhoto>()));
    gh.singleton<_i186.BaseRepositoryGetUserInfo>(
        () => _i187.GetUserInfoRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              getUserInfoWebService: gh<_i90.GetUserInfoWebService>(),
            ));
    gh.factory<_i188.GetUserInfo2Cubit>(
        () => _i188.GetUserInfo2Cubit(gh<_i167.BaseRepositoryGetUserInfo2>()));
    gh.singleton<_i189.BaseRepositoryRating>(() => _i190.RatingRepositoryImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          ratingWebService: gh<_i49.RatingWebService>(),
        ));
    gh.singleton<_i191.BaseRepositoryCreateVoucher>(
        () => _i192.CreateVoucherRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              createVoucherWebService: gh<_i61.CreateVoucherWebService>(),
            ));
    gh.factory<_i193.QuraanVisitorCubit>(() =>
        _i193.QuraanVisitorCubit(gh<_i143.BaseRepositoryQuraanVisitor>()));
    gh.factory<_i194.GetalloffersCubit>(
        () => _i194.GetalloffersCubit(gh<_i96.BaseRepositoryGetAllOffers>()));
    gh.factory<_i195.CartitemsCubit>(
        () => _i195.CartitemsCubit(gh<_i115.BaseRepositoryCartItems>()));
    gh.singleton<_i196.BaseRepositoryOnArrival>(
        () => _i197.OnArrivalRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              onArrivalWebService: gh<_i81.OnArrivalWebService>(),
            ));
    gh.factory<_i198.RatingCubit>(
        () => _i198.RatingCubit(gh<_i189.BaseRepositoryRating>()));
    gh.factory<_i199.StationeryCubit>(
        () => _i199.StationeryCubit(gh<_i120.BaseRepositoryStationery>()));
    gh.factory<_i200.DeleteitemfromcartCubit>(() =>
        _i200.DeleteitemfromcartCubit(
            gh<_i72.BaseRepositoryDeleteItemFromCart>()));
    gh.factory<_i201.GetOrdersCubit>(
        () => _i201.GetOrdersCubit(gh<_i174.BaseRepositoryGetOrders>()));
    gh.factory<_i202.OnArrivalCubit>(
        () => _i202.OnArrivalCubit(gh<_i196.BaseRepositoryOnArrival>()));
    gh.factory<_i203.SearchResultsCubit>(() =>
        _i203.SearchResultsCubit(gh<_i148.BaseRepositorySearchResults>()));
    gh.factory<_i204.SendOfferCubit>(
        () => _i204.SendOfferCubit(gh<_i98.BaseRepositorySendOffer>()));
    gh.factory<_i205.NewsCubit>(
        () => _i205.NewsCubit(gh<_i172.BaseRepositoryNews>()));
    gh.factory<_i206.GetCitiesCubit>(
        () => _i206.GetCitiesCubit(gh<_i118.BaseRepositoryGetCities>()));
    gh.factory<_i207.GetNotificationsCubit>(() => _i207.GetNotificationsCubit(
        gh<_i160.BaseRepositoryGetNotifications>()));
    gh.factory<_i208.SectionVisitorCubit>(() =>
        _i208.SectionVisitorCubit(gh<_i150.BaseRepositorySectionVisitor>()));
    gh.factory<_i209.QuraanCubit>(
        () => _i209.QuraanCubit(gh<_i137.BaseRepositoryQuraan>()));
    gh.factory<_i210.GetfavoritesCubit>(
        () => _i210.GetfavoritesCubit(gh<_i170.BaseRepositoryGetFavorites>()));
    gh.factory<_i211.StationeryVisitorCubit>(() => _i211.StationeryVisitorCubit(
        gh<_i130.BaseRepositoryStationeryVisitor>()));
    gh.factory<_i212.CreateVoucherCubit>(() =>
        _i212.CreateVoucherCubit(gh<_i191.BaseRepositoryCreateVoucher>()));
    gh.factory<_i213.GetUserInfoCubit>(
        () => _i213.GetUserInfoCubit(gh<_i186.BaseRepositoryGetUserInfo>()));
    gh.factory<_i214.BookCubit>(
        () => _i214.BookCubit(gh<_i183.BaseRepositoryBook>()));
    return this;
  }
}

class _$ThirdPartyInjection extends _i215.ThirdPartyInjection {}
