...
import 'Core/third_party_injection.dart' as _i179;
import 'Core/utils/shared_preference_utils.dart' as _i7;
import 'Features/Auth/Create%20Account/cubit/createaccount_cubit.dart' as _i135;
...
import 'Features/Auth/Create%20Account/Data/Web%20Service/createaccountwebservice.dart'
    as _i20;
import 'Features/Auth/Login/cubit/login_cubit.dart' as _i148;
import 'Features/Auth/Login/data/Repostry/basereposotrylogin.dart' as _i81;
import 'Features/Auth/Login/data/Repostry/loginreposotry.dart' as _i82;
...
import 'Features/User/Details/data/Web%20Service/stationery_webservice.dart'
    as _i57;
import 'Features/User/Details/Manager/Base%20Cubit/base_cubit.dart' as _i128;
import 'Features/User/Details/Manager/Book%20Cubit/book_cubit.dart' as _i178;
import 'Features/User/Details/Manager/DisLike%20Cubit/dis_like_cubit.dart'
    as _i115;
import 'Features/User/Details/Manager/Game%20Cubit/game_cubit.dart' as _i101;
import 'Features/User/Details/Manager/Like%20Cubit/like_cubit.dart' as _i147;
...
import 'Features/User/favorite/Manager/Get%20Favorites%20Cubit/getfavorites_cubit.dart'
    as _i175;
import 'Features/User/homepage/HomeScreen/cubit/section_cubit.dart' as _i114;
...
import 'Features/User/news/data/Repostry/News/baserepositorymewdetails.dart'
    as _i83;
import 'Features/User/news/data/Repostry/News/baserepositorynews.dart' as _i143;
import 'Features/User/news/data/Repostry/News/newdetailsrepository.dart'
    as _i84;
import 'Features/User/news/data/Repostry/News/newsrepository.dart' as _i144;
...
import 'Features/User/news/Manager/New%20Details%20Cubit/new_details_cubit.dart'
    as _i87;
import 'Features/User/news/Manager/News%20Cubit/news_cubit.dart' as _i170;
import 'Features/User/note/cubit/get_notifications_cubit.dart' as _i172;
import 'Features/User/note/data/Repostry/baserepositorygetnotifications.dart'
    as _i133;
import 'Features/User/note/data/Repostry/getnotificationsentity.dart' as _i134;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.singleton<_i75.GetUserInfoWebService>(
        () => _i75.GetUserInfoWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i76.SearchByQrWebService>(
        () => _i76.SearchByQrWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i77.BaseRepositoryOrderDetails>(
        () => _i78.OrderDetailsRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              orderDetailsWebService: gh<_i21.OrderDetailsWebService>(),
            ));
    gh.singleton<_i79.BaseRepositoryGetAllOffers>(
        () => _i80.GetAllOffersRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              getAllOffersWebService: gh<_i69.GetAllOffersWebService>(),
            ));
    gh.singleton<_i81.BaseReposotryLogin>(() => _i82.LoginReposotryImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          loginWebService: gh<_i58.LoginWebService>(),
        ));
    gh.singleton<_i83.BaseRepositoryNewDetails>(
        () => _i84.NewDetailsRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              newDetailsWebService: gh<_i32.NewDetailsWebService>(),
            ));
    gh.singleton<_i85.BaseRepositoryAddToFavorites>(
        () => _i86.AddToFavoritesRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              addToFavoriteWebService: gh<_i65.AddToFavoritesWebService>(),
            ));
    gh.factory<_i87.NewDetailsCubit>(
        () => _i87.NewDetailsCubit(gh<_i83.BaseRepositoryNewDetails>()));
    gh.singleton<_i88.BaseRepositoryGetProductsOfSubSection>(
        () => _i89.GetProductsofSubSectionRepository(
              networkInfo: gh<_i8.NetworkInfo>(),
              getProductsofSubSectionWebService:
                  gh<_i39.GetProductsofSubSectionWebService>(),
            ));
    gh.singleton<_i90.BaseRepositorySearchByQr>(
        () => _i91.SearchByQrRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              searchByQrWebService: gh<_i76.SearchByQrWebService>(),
            ));
    gh.singleton<_i92.BaseRepositoryGame>(() => _i93.GameRepository(
          networkInfo: gh<_i8.NetworkInfo>(),
          gameWebService: gh<_i37.GameWebService>(),
        ));
    gh.singleton<_i94.BaseRepositoryCartItems>(
        () => _i95.GetCartItemsRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              cartItemsWebService: gh<_i59.CartItemsWebService>(),
            ));
    gh.factory<_i96.GetsubsectionsCubit>(() =>
        _i96.GetsubsectionsCubit(gh<_i34.BaseRepositoryGetSubSections>()));
    gh.singleton<_i97.BaseRepositoryGetCities>(
        () => _i98.GetCitiesRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              getCitiesWebService: gh<_i74.GetCitiesWebService>(),
            ));
    gh.singleton<_i99.BaseRepositoryStationery>(
        () => _i100.StationeryRepository(
              networkInfo: gh<_i8.NetworkInfo>(),
              stationeryWebService: gh<_i57.StationeryWebService>(),
            ));
    gh.factory<_i101.GameCubit>(
        () => _i101.GameCubit(gh<_i92.BaseRepositoryGame>()));
    gh.singleton<_i102.BaseRepositorySection>(() => _i103.SectionRepositoryImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          sectionWebService: gh<_i16.SectionWebService>(),
        ));
    gh.singleton<_i104.BaseRepositoryDisLike>(() => _i105.DisLikeRepositoryImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          disLikeWebService: gh<_i15.DisLikeWebService>(),
        ));
    gh.factory<_i106.PopularProductsCubit>(() =>
        _i106.PopularProductsCubit(gh<_i52.BaseRepositoryPopularProducts>()));
    gh.singleton<_i107.BaseRepositoryStationeryVisitor>(() =>
        _i108.StationeryRepositoryVisitorImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          stationeryWebServiceVisitor: gh<_i12.StationeryWebServiceVisitor>(),
        ));
    gh.singleton<_i109.BaseRepositoryTransfer>(
        () => _i110.TransferRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              transferWebService: gh<_i44.TransferWebService>(),
            ));
    gh.factory<_i111.QuantitiyupdateCubit>(() =>
        _i111.QuantitiyupdateCubit(gh<_i55.BaseRepositoryQuantityUpdate>()));
    gh.singleton<_i112.BaseRepositoryQuraan>(() => _i113.QuraanRepository(
          networkInfo: gh<_i8.NetworkInfo>(),
          quraanWebService: gh<_i11.QuraanWebService>(),
        ));
    gh.factory<_i114.SectionCubit>(
        () => _i114.SectionCubit(gh<_i102.BaseRepositorySection>()));
    gh.factory<_i115.DisLikeCubit>(
        () => _i115.DisLikeCubit(gh<_i104.BaseRepositoryDisLike>()));
    gh.factory<_i116.SearchByQrCubit>(
        () => _i116.SearchByQrCubit(gh<_i90.BaseRepositorySearchByQr>()));
    gh.singleton<_i117.BaseRepositoryQuraanVisitor>(
        () => _i118.QuraanRepositoryVisitorImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              quraanWebServiceVisitor: gh<_i17.QuraanWebServiceVisitor>(),
            ));
    gh.singleton<_i119.BaseRepositoryBase>(() => _i120.BaseRepositoryImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          baseWebService: gh<_i30.BaseWebService>(),
        ));
    gh.factory<_i121.GameVisitorCubit>(
        () => _i121.GameVisitorCubit(gh<_i61.BaseRepositoryGameVisitor>()));
    gh.singleton<_i122.BaseRepositorySearchResults>(
        () => _i123.SearchResultsRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              resultsWebService: gh<_i45.SearchResultsWebService>(),
            ));
    gh.singleton<_i124.BaseRepositorySectionVisitor>(
        () => _i125.SectionVisitorRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              sectionVisitorWebService: gh<_i19.SectionVisitorWebService>(),
            ));
    gh.singleton<_i126.BaseRepositoryAddtoCart>(
        () => _i127.AddtoCartRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              addtoCartWebService: gh<_i31.AddtoCartWebService>(),
            ));
    gh.factory<_i128.BaseCubit>(
        () => _i128.BaseCubit(gh<_i119.BaseRepositoryBase>()));
    gh.factory<_i129.AddtofavoriteCubit>(() =>
        _i129.AddtofavoriteCubit(gh<_i85.BaseRepositoryAddToFavorites>()));
    gh.factory<_i130.DetailsofofferCubit>(() =>
        _i130.DetailsofofferCubit(gh<_i72.BaseRepositoryDetailsofOffer>()));
    gh.factory<_i131.AddtocartCubit>(
        () => _i131.AddtocartCubit(gh<_i126.BaseRepositoryAddtoCart>()));
    gh.factory<_i132.TransferCubit>(
        () => _i132.TransferCubit(gh<_i109.BaseRepositoryTransfer>()));
    gh.singleton<_i133.BaseRepositoryGetNotifications>(
        () => _i134.GetNotificationsRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              getNotificationsWebService: gh<_i22.GetNotificationsWebService>(),
            ));
    gh.factory<_i135.CreateaccountCubit>(
        () => _i135.CreateaccountCubit(gh<_i47.BaseReposotryCreateAccount>()));
    gh.singleton<_i136.BaseRepositoryBookVisitor>(
        () => _i137.BookRepositoryVisitorImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              bookWebServiceVisitor: gh<_i33.BookWebServiceVisitor>(),
            ));
    gh.singleton<_i138.BaseRepositoryBaseVisitor>(
        () => _i139.BaseRepositoryVisitorImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              baseWebServiceVisitor: gh<_i18.BaseWebServiceVisitor>(),
            ));
    gh.factory<_i140.BaseVisitorCubit>(
        () => _i140.BaseVisitorCubit(gh<_i138.BaseRepositoryBaseVisitor>()));
    gh.singleton<_i141.BaseRepositoryGetFavorites>(
        () => _i142.GetFavoritesRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              getFavoritesWebService: gh<_i54.GetFavoritesWebService>(),
            ));
    gh.singleton<_i143.BaseRepositoryNews>(() => _i144.NewsRepositoryImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          newsWebService: gh<_i29.NewsWebService>(),
        ));
    gh.singleton<_i145.BaseRepositoryGetOrders>(
        () => _i146.GetOrdersRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              getOrdersWebService: gh<_i66.GetOrdersWebService>(),
            ));
    gh.factory<_i147.LikeCubit>(
        () => _i147.LikeCubit(gh<_i50.BaseRepositoryLike>()));
    gh.factory<_i148.LoginCubit>(() => _i148.LoginCubit(
          gh<_i81.BaseReposotryLogin>(),
          gh<_i7.SharedPreferencesUtils>(),
        ));
    gh.factory<_i149.BookVisitorCubit>(
        () => _i149.BookVisitorCubit(gh<_i136.BaseRepositoryBookVisitor>()));
    gh.factory<_i150.OrderDetailsCubit>(
        () => _i150.OrderDetailsCubit(gh<_i77.BaseRepositoryOrderDetails>()));
    gh.factory<_i151.SendOrderCubit>(
        () => _i151.SendOrderCubit(gh<_i67.BaseRepositorySendOrder>()));
    gh.factory<_i152.GetproductsofsubsectionCubit>(() =>
        _i152.GetproductsofsubsectionCubit(
            gh<_i88.BaseRepositoryGetProductsOfSubSection>()));
    gh.singleton<_i153.BaseRepositoryBook>(() => _i154.Bookrepository(
          networkInfo: gh<_i8.NetworkInfo>(),
          bookWebService: gh<_i60.BookWebService>(),
        ));
    gh.singleton<_i155.BaseRepositoryGetUserInfo>(
        () => _i156.GetUserInfoRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              getUserInfoWebService: gh<_i75.GetUserInfoWebService>(),
            ));
    gh.singleton<_i157.BaseRepositoryRating>(() => _i158.RatingRepositoryImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          ratingWebService: gh<_i46.RatingWebService>(),
        ));
    gh.factory<_i159.QuraanVisitorCubit>(() =>
        _i159.QuraanVisitorCubit(gh<_i117.BaseRepositoryQuraanVisitor>()));
    gh.factory<_i160.GetalloffersCubit>(
        () => _i160.GetalloffersCubit(gh<_i79.BaseRepositoryGetAllOffers>()));
    gh.factory<_i161.CartitemsCubit>(
        () => _i161.CartitemsCubit(gh<_i94.BaseRepositoryCartItems>()));
    gh.singleton<_i162.BaseRepositoryOnArrival>(
        () => _i163.OnArrivalRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              onArrivalWebService: gh<_i71.OnArrivalWebService>(),
            ));
    gh.factory<_i164.RatingCubit>(
        () => _i164.RatingCubit(gh<_i157.BaseRepositoryRating>()));
    gh.factory<_i165.StationeryCubit>(
        () => _i165.StationeryCubit(gh<_i99.BaseRepositoryStationery>()));
    gh.factory<_i166.DeleteitemfromcartCubit>(() =>
        _i166.DeleteitemfromcartCubit(
            gh<_i63.BaseRepositoryDeleteItemFromCart>()));
    gh.factory<_i167.GetOrdersCubit>(
        () => _i167.GetOrdersCubit(gh<_i145.BaseRepositoryGetOrders>()));
    gh.factory<_i168.OnArrivalCubit>(
        () => _i168.OnArrivalCubit(gh<_i162.BaseRepositoryOnArrival>()));
    gh.factory<_i169.SearchResultsCubit>(() =>
        _i169.SearchResultsCubit(gh<_i122.BaseRepositorySearchResults>()));
    gh.factory<_i170.NewsCubit>(
        () => _i170.NewsCubit(gh<_i143.BaseRepositoryNews>()));
    gh.factory<_i171.GetCitiesCubit>(
        () => _i171.GetCitiesCubit(gh<_i97.BaseRepositoryGetCities>()));
    gh.factory<_i172.GetNotificationsCubit>(() => _i172.GetNotificationsCubit(
        gh<_i133.BaseRepositoryGetNotifications>()));
    gh.factory<_i173.SectionVisitorCubit>(() =>
        _i173.SectionVisitorCubit(gh<_i124.BaseRepositorySectionVisitor>()));
    gh.factory<_i174.QuraanCubit>(
        () => _i174.QuraanCubit(gh<_i112.BaseRepositoryQuraan>()));
    gh.factory<_i175.GetfavoritesCubit>(
        () => _i175.GetfavoritesCubit(gh<_i141.BaseRepositoryGetFavorites>()));
    gh.factory<_i176.StationeryVisitorCubit>(() => _i176.StationeryVisitorCubit(
        gh<_i107.BaseRepositoryStationeryVisitor>()));
    gh.factory<_i177.GetUserInfoCubit>(
        () => _i177.GetUserInfoCubit(gh<_i155.BaseRepositoryGetUserInfo>()));
    gh.factory<_i178.BookCubit>(
        () => _i178.BookCubit(gh<_i153.BaseRepositoryBook>()));
    return this;
  }
}

class _$ThirdPartyInjection extends _i179.ThirdPartyInjection {}
