...
import 'Core/third_party_injection.dart' as _i111;
import 'Core/utils/shared_preference_utils.dart' as _i7;
import 'Features/Auth/Create%20Account/cubit/createaccount_cubit.dart' as _i87;
...
import 'Features/Auth/Create%20Account/Data/Web%20Service/createaccountwebservice.dart'
    as _i14;
import 'Features/Auth/Login/cubit/login_cubit.dart' as _i92;
import 'Features/Auth/Login/data/Repostry/basereposotrylogin.dart' as _i52;
import 'Features/Auth/Login/data/Repostry/loginreposotry.dart' as _i53;
import 'Features/Auth/Login/data/Web%20Service/loginwebservice.dart' as _i34;
...
import 'Features/User/Details/data/Repostry/Stationery%20Repository/stationeryrepository.dart'
    as _i66;
import 'Features/User/Details/data/Web%20Service/base_webservice.dart' as _i19;
import 'Features/User/Details/data/Web%20Service/book_webservice.dart' as _i36;
import 'Features/User/Details/data/Web%20Service/game_webservice.dart' as _i23;
...
import 'Features/User/Details/data/Web%20Service/stationery_webservice.dart'
    as _i33;
import 'Features/User/Details/Manager/Base%20Cubit/base_cubit.dart' as _i80;
import 'Features/User/Details/Manager/Book%20Cubit/book_cubit.dart' as _i110;
import 'Features/User/Details/Manager/Game%20Cubit/game_cubit.dart' as _i67;
...
import 'Features/User/favorite/Manager/Get%20Favorites%20Cubit/getfavorites_cubit.dart'
    as _i109;
import 'Features/User/homepage/HomeScreen/cubit/section_cubit.dart' as _i73;
...
import 'Features/User/news/Manager/Get%20All%20Offers%20Cubit/getalloffers_cubit.dart'
    as _i98;
import 'Features/User/note/cubit/get_notifications_cubit.dart' as _i107;
import 'Features/User/note/data/Repostry/baserepositorygetnotifications.dart'
    as _i85;
import 'Features/User/note/data/Repostry/getnotificationsentity.dart' as _i86;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.singleton<_i19.BaseWebService>(
        () => _i19.BaseWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i20.AddtoCartWebService>(
        () => _i20.AddtoCartWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i21.BaseRepositoryGetSubSections>(
        () => _i22.GetSubSectionsRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              getSubSectionsWebService: gh<_i12.GetSubSectionsWebService>(),
            ));
    gh.singleton<_i23.GameWebService>(
        () => _i23.GameWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i24.DetailsofOfferWebService>(
        () => _i24.DetailsofOfferWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i25.GetProductsofSubSectionWebService>(() =>
        _i25.GetProductsofSubSectionWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i26.TransferWebService>(
        () => _i26.TransferWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i27.BaseReposotryCreateAccount>(
        () => _i28.CreateAccountRepostryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              accountWebService: gh<_i14.CreateAccountWebService>(),
            ));
    gh.singleton<_i29.QuantityUpdateWebService>(
        () => _i29.QuantityUpdateWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i30.GetFavoritesWebService>(
        () => _i30.GetFavoritesWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i31.BaseRepositoryQuantityUpdate>(
        () => _i32.QuantityUpdateRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              quantityUpdateWebService: gh<_i29.QuantityUpdateWebService>(),
            ));
    gh.singleton<_i33.StationeryWebService>(
        () => _i33.StationeryWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i34.LoginWebService>(
        () => _i34.LoginWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i35.CartItemsWebService>(
        () => _i35.CartItemsWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i36.BookWebService>(
        () => _i36.BookWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i37.BaseRepositoryDeleteItemFromCart>(() =>
        _i38.DeleteItemFromCartRepositoryImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          deleteItemFromCartWebService: gh<_i18.DeleteItemFromCartWebService>(),
        ));
    gh.singleton<_i39.AddToFavoritesWebService>(
        () => _i39.AddToFavoriteWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i40.GetOrdersWebService>(
        () => _i40.GetOrdersWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i41.BaseRepositorySendOrder>(
        () => _i42.SendOrderRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              sendOrderWebService: gh<_i17.SendOrderWebService>(),
            ));
    gh.singleton<_i43.GetAllOffersWebService>(
        () => _i43.GetAllOffersWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i44.OnArrivalWebService>(
        () => _i44.OnArrivalWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i45.BaseRepositoryDetailsofOffer>(
        () => _i46.DetailsofOfferRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              detailsofOfferWebService: gh<_i24.DetailsofOfferWebService>(),
            ));
    gh.singleton<_i47.GetCitiesWebService>(
        () => _i47.GetCitiesWebServiceImpl(gh<_i9.ApiConsumer>()));
    gh.singleton<_i48.BaseRepositoryOrderDetails>(
        () => _i49.OrderDetailsRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              orderDetailsWebService: gh<_i15.OrderDetailsWebService>(),
            ));
    gh.singleton<_i50.BaseRepositoryGetAllOffers>(
        () => _i51.GetAllOffersRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              getAllOffersWebService: gh<_i43.GetAllOffersWebService>(),
            ));
    gh.singleton<_i52.BaseReposotryLogin>(() => _i53.LoginReposotryImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          loginWebService: gh<_i34.LoginWebService>(),
        ));
    gh.singleton<_i54.BaseRepositoryAddToFavorites>(
        () => _i55.AddToFavoritesRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              addToFavoriteWebService: gh<_i39.AddToFavoritesWebService>(),
            ));
    gh.singleton<_i56.BaseRepositoryGetProductsOfSubSection>(
        () => _i57.GetProductsofSubSectionRepository(
              networkInfo: gh<_i8.NetworkInfo>(),
              getProductsofSubSectionWebService:
                  gh<_i25.GetProductsofSubSectionWebService>(),
            ));
    gh.singleton<_i58.BaseRepositoryGame>(() => _i59.GameRepository(
          networkInfo: gh<_i8.NetworkInfo>(),
          gameWebService: gh<_i23.GameWebService>(),
        ));
    gh.singleton<_i60.BaseRepositoryCartItems>(
        () => _i61.GetCartItemsRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              cartItemsWebService: gh<_i35.CartItemsWebService>(),
            ));
    gh.factory<_i62.GetsubsectionsCubit>(() =>
        _i62.GetsubsectionsCubit(gh<_i21.BaseRepositoryGetSubSections>()));
    gh.singleton<_i63.BaseRepositoryGetCities>(
        () => _i64.GetCitiesRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              getCitiesWebService: gh<_i47.GetCitiesWebService>(),
            ));
    gh.singleton<_i65.BaseRepositoryStationery>(() => _i66.StationeryRepository(
          networkInfo: gh<_i8.NetworkInfo>(),
          stationeryWebService: gh<_i33.StationeryWebService>(),
        ));
    gh.factory<_i67.GameCubit>(
        () => _i67.GameCubit(gh<_i58.BaseRepositoryGame>()));
    gh.singleton<_i68.BaseRepositorySection>(() => _i69.SectionRepositoryImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          sectionWebService: gh<_i13.SectionWebService>(),
        ));
    gh.factory<_i70.QuantitiyupdateCubit>(() =>
        _i70.QuantitiyupdateCubit(gh<_i31.BaseRepositoryQuantityUpdate>()));
    gh.singleton<_i71.BaseRepositoryQuraan>(() => _i72.QuraanRepository(
          networkInfo: gh<_i8.NetworkInfo>(),
          quraanWebService: gh<_i11.QuraanWebService>(),
        ));
    gh.factory<_i73.SectionCubit>(
        () => _i73.SectionCubit(gh<_i68.BaseRepositorySection>()));
    gh.singleton<_i74.BaseRepositoryBase>(() => _i75.BaseRepositoryImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          baseWebService: gh<_i19.BaseWebService>(),
        ));
    gh.singleton<_i76.BaseRepositoryTransfer>(() => _i77.TransferRepositoryImpl(
          networkInfo: gh<_i8.NetworkInfo>(),
          transferWebService: gh<_i26.TransferWebService>(),
        ));
    gh.singleton<_i78.BaseRepositoryAddtoCart>(
        () => _i79.AddtoCartRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              addtoCartWebService: gh<_i20.AddtoCartWebService>(),
            ));
    gh.factory<_i80.BaseCubit>(
        () => _i80.BaseCubit(gh<_i74.BaseRepositoryBase>()));
    gh.factory<_i81.AddtofavoriteCubit>(
        () => _i81.AddtofavoriteCubit(gh<_i54.BaseRepositoryAddToFavorites>()));
    gh.factory<_i82.DetailsofofferCubit>(() =>
        _i82.DetailsofofferCubit(gh<_i45.BaseRepositoryDetailsofOffer>()));
    gh.factory<_i83.AddtocartCubit>(
        () => _i83.AddtocartCubit(gh<_i78.BaseRepositoryAddtoCart>()));
    gh.factory<_i84.TransferCubit>(
        () => _i84.TransferCubit(gh<_i76.BaseRepositoryTransfer>()));
    gh.singleton<_i85.BaseRepositoryGetNotifications>(
        () => _i86.GetNotificationsRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              getNotificationsWebService: gh<_i16.GetNotificationsWebService>(),
            ));
    gh.factory<_i87.CreateaccountCubit>(
        () => _i87.CreateaccountCubit(gh<_i27.BaseReposotryCreateAccount>()));
    gh.singleton<_i88.BaseRepositoryGetFavorites>(
        () => _i89.GetFavoritesRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              getFavoritesWebService: gh<_i30.GetFavoritesWebService>(),
            ));
    gh.singleton<_i90.BaseRepositoryGetOrders>(
        () => _i91.GetOrdersRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              getOrdersWebService: gh<_i40.GetOrdersWebService>(),
            ));
    gh.factory<_i92.LoginCubit>(() => _i92.LoginCubit(
          gh<_i52.BaseReposotryLogin>(),
          gh<_i7.SharedPreferencesUtils>(),
        ));
    gh.factory<_i93.OrderDetailsCubit>(
        () => _i93.OrderDetailsCubit(gh<_i48.BaseRepositoryOrderDetails>()));
    gh.factory<_i94.SendOrderCubit>(
        () => _i94.SendOrderCubit(gh<_i41.BaseRepositorySendOrder>()));
    gh.factory<_i95.GetproductsofsubsectionCubit>(() =>
        _i95.GetproductsofsubsectionCubit(
            gh<_i56.BaseRepositoryGetProductsOfSubSection>()));
    gh.singleton<_i96.BaseRepositoryBook>(() => _i97.Bookrepository(
          networkInfo: gh<_i8.NetworkInfo>(),
          bookWebService: gh<_i36.BookWebService>(),
        ));
    gh.factory<_i98.GetalloffersCubit>(
        () => _i98.GetalloffersCubit(gh<_i50.BaseRepositoryGetAllOffers>()));
    gh.factory<_i99.CartitemsCubit>(
        () => _i99.CartitemsCubit(gh<_i60.BaseRepositoryCartItems>()));
    gh.singleton<_i100.BaseRepositoryOnArrival>(
        () => _i101.OnArrivalRepositoryImpl(
              networkInfo: gh<_i8.NetworkInfo>(),
              onArrivalWebService: gh<_i44.OnArrivalWebService>(),
            ));
    gh.factory<_i102.StationeryCubit>(
        () => _i102.StationeryCubit(gh<_i65.BaseRepositoryStationery>()));
    gh.factory<_i103.DeleteitemfromcartCubit>(() =>
        _i103.DeleteitemfromcartCubit(
            gh<_i37.BaseRepositoryDeleteItemFromCart>()));
    gh.factory<_i104.GetOrdersCubit>(
        () => _i104.GetOrdersCubit(gh<_i90.BaseRepositoryGetOrders>()));
    gh.factory<_i105.OnArrivalCubit>(
        () => _i105.OnArrivalCubit(gh<_i100.BaseRepositoryOnArrival>()));
    gh.factory<_i106.GetCitiesCubit>(
        () => _i106.GetCitiesCubit(gh<_i63.BaseRepositoryGetCities>()));
    gh.factory<_i107.GetNotificationsCubit>(() =>
        _i107.GetNotificationsCubit(gh<_i85.BaseRepositoryGetNotifications>()));
    gh.factory<_i108.QuraanCubit>(
        () => _i108.QuraanCubit(gh<_i71.BaseRepositoryQuraan>()));
    gh.factory<_i109.GetfavoritesCubit>(
        () => _i109.GetfavoritesCubit(gh<_i88.BaseRepositoryGetFavorites>()));
    gh.factory<_i110.BookCubit>(
        () => _i110.BookCubit(gh<_i96.BaseRepositoryBook>()));
    return this;
  }
}

class _$ThirdPartyInjection extends _i111.ThirdPartyInjection {}
