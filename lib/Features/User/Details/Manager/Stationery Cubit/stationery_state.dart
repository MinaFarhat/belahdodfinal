...
class StationeryState with _$StationeryState {
  ...
  const factory StationeryState.success(StationeryEntity stationeryentity) = _Success;
  const factory StationeryState.error(NetworkExceptions networkExceptions) = _Error;
}
